...
class MainSortClass {
    ...
    // increasing order
    void mergeParts(int indexLow, int middle, int indexHigh) {
    ...
    void mergeSortandTimer() {
        ...
        System.out.println("The elapsed time from the start of the program to the end is: " + total);
        time = total;
        print();
    }
}
